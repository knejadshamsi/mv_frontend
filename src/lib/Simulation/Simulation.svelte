<script lang="ts">
    ...
    import ScenaroOne from "./1/ScenaroOne.svelte"
    import ScenaroTwo from "./2/ScenaroTwo.svelte"
    ...
    function test(event: { detail: { id: any; }; }){
...
<div id="anime_control_con">
  <AnimeControls/>
  <ScenarioMenu on:ScenarioSwitch={test}/>
</div>

{#if (scenario_toggle["1"] == true)}
<ScenaroOne/>
{/if}
{#if (scenario_toggle["2"] == true)}
<!----<ScenaroTwo/>-->
{/if}
<!--{#if (scenario_toggle["3"] == true)}
<Marker lngLat={umo} class="car2">
